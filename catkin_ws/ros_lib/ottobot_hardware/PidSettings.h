#ifndef _ROS_ottobot_hardware_PidSettings_h
#define _ROS_ottobot_hardware_PidSettings_h
...
namespace ottobot_hardware
{
  ...
  class PidSettings : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ottobot_hardware/PidSettings"; };
