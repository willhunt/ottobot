#ifndef _ROS_SERVICE_JointUpdate_h
#define _ROS_SERVICE_JointUpdate_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char JOINTUPDATE[] = "ottobot_hardware/JointUpdate";

  class JointUpdateRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return JOINTUPDATE; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class JointUpdateResponse : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return JOINTUPDATE; };
    const char * getMD5(){ return "5703dc153b077fbca188a602cb8df8ed"; };

  };

  class JointUpdate {
    public:
    typedef JointUpdateRequest Request;
    typedef JointUpdateResponse Response;
  };
